...
//  m_UseAlternativeMetricForAffine=false;
  m_UseAlternativeMetricForRigid=false;
...
//  m_LandmarkRegValid = false;
  ...
  m_RigidNumberOfIterations = 150 ;
  m_RigidNumberOfSpatialSamples = 70000 ;
...
//  m_AffineMetricValue = 0;
  ...
  m_HighInterpolationQuality=true;
  m_DefaultBackgroundPixelValue=0;
  }
...
::RegisterUsingRigid()
  ...
  if (m_UseAlternativeMetricForRigid)
  {
    registrator->SetUseAlternativeMetric();
  }
  else
  {
  registrator->SetUseDefaultMetric();
  }
  ...
  registrator->SetMetricNumberOfSpatialSamples(m_RigidNumberOfSpatialSamples);
...
//  if (m_UseAlternativeMetricForAffine)
//  {
//    registrator->SetUseAlternativeMetric();
//  }
//  else
...
//  registrator->SetMetricNumberOfSpatialSamples(m_AffineNumberOfSpatialSamples);
...
::GetNoneRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetNoneAffineTransform(),
...
::GetCenterRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetCenterAffineTransform(),
                                  m_MovingImage, m_FixedImage);
  }
...
::GetMassRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetMassAffineTransform(),
                                  m_MovingImage, m_FixedImage);
  }
...
::GetMomentRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetMomentAffineTransform(),
                                  m_MovingImage, m_FixedImage);
  }
...
::GetLoadedRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetLoadedAffineTransform(),
                                  m_MovingImage, m_FixedImage);
  }
...
::GetRigidRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetRigidAffineTransform(),
                                  m_MovingImage, m_FixedImage);
  }
...
::GetFinalRegisteredMovingImage()
  {
  return ResampleUsingTransform(this->GetFinalTransform(),
                                  m_MovingImage, m_FixedImage);
  }
...
typename ImageRegistrationApp< TImage >::ImagePointer
ImageRegistrationApp< TImage >
::ResampleUsingTransform(AffineTransformType * transform,
  ...
  resample->SetDefaultPixelValue(m_DefaultBackgroundPixelValue);
